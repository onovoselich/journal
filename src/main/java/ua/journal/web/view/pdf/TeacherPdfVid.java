package ua.journal.web.view.pdf;
...
public class TeacherPdfVid extends AbstractPdfView implements Vidomist_H5_03 {
    ...
    protected void buildPdfDocument(Map<String, Object> model,
        ...
        document.add(newParagraph(COURSE, ua.journal.logic.Number.arabic2roman(grp.getEducYear()), GROUP, grp.getName(), times));
...
/*        if (grp.getStartDate() != null) stYear = grp.getStartDate().substring(0, 4);
        ...
        document.add(newParagraph(SYM, ua.journal.logic.Number.arabic2roman(sum), times));
